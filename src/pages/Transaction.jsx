...
function Transaction() {
  ...
  return (
    <>
      <div className="mt-3">
        <button
          className="button is-secondary mb-3"
          onClick={() => {
            setreceiver((pv) => ({
              ...pv,
        ...
        <div className="field">
          ...
          <div className="control">
            <input
              ...
              name="userToPay"
              onChange={(e) => {
                setreceiver((pv) => ({ ...pv, wallet: e.target.value }));
              }}
            />
          </div>
        </div>
        <div className="field">
          ...
          <div className="control">
            <input
              ...
              name="amount"
              onChange={(e) => {
                setreceiver((pv) => ({ ...pv, amount: e.target.value }));
              }}
            />
          </div>
        </div>
        ...
        <div className="field is-grouped">
          <div className="control">
            <button
              ...
              disabled={
                wallet.publicKey.toString() === receiver.wallet ||
                !receiver.amount ||
                !receiver.wallet
              }
              onClick={handleTranasaction}
            >
              send sol
            </button>
          </div>
          ...
          <div className="control">
            <button
              ...
              disabled={!receiver.amount || !receiver.wallet}
